...
export const createProduct = async (req, res) => {
    ...
    try {
        ...
        res.status(201).json({ message: 'Product Created', status_code: 201 })
    } catch (error) {
        return res
            .status(501)
...
export const updateProduct = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Product Updated', status_code: 200 })
    } catch (error) {
        return res
            .status(501)
            .json({ message: `${error.message}`, status_code: 501 })
...
export const deleteProduct = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ message: 'Product Deleted', status_code: 200 })
    } catch (error) {
        return res
            .status(501)
            .json({ message: `${error.message}`, status_code: 501 })
